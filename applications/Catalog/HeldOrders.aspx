<%@ Page Language="VB" MasterPageFile="~/DUIMasterPage.master" AutoEventWireup="false" CodeFile="HeldOrders.aspx.vb" Inherits="HeldOrders" title="Untitled Page" %>
  ...
  <table style="width: 90%; " align=center>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="htmff1" HeaderText="Backorder(B)" >
                            <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
