<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CatEntryPDF.aspx.vb" Inherits="CatEntryPDF" %> 
                ...
                <table width=98%>
                    ...
                    <tr>
                        <td align="center" valign="middle" nowrap="noWrap">
                            <asp:Label ID="label18" runat="server" Text="Comments:" Font-Size="14pt" Font-Bold="True" ForeColor="DarkGreen"></asp:Label>
                        </td>
                        <td colspan=3>
