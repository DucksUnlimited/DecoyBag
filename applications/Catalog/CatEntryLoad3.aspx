<%@ Page Language="VB" MasterPageFile="~/DUIMasterPage.master" AutoEventWireup="false" CodeFile="CatEntryLoad3.aspx.vb" Inherits="CatEntryLoad3" title="Start New Order" %>
        ...
        <table style="width: 90%;" cellpadding="5" align=center >
            <tr>
                ...
                <td align=left width=280px>
                    <asp:TextBox ID="evid" runat="server" MaxLength=8 Width="70px" Text="MO00831B"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td>&nbsp;</td>
                <td align=left>
                    <asp:TextBox ID="evdate" runat="server" MaxLength=8 Width="70px" Text="20150509"></asp:TextBox>
            ...
            <tr>
                ...
                <td>&nbsp;</td>
                <td align=left>
                    <asp:TextBox ID="usrid" runat="server" MaxLength=9 Width="75px" Text="000038192"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td>&nbsp;</td>
                <td align=left>
                    <asp:TextBox ID="rdid" runat="server" MaxLength=9 Width="75px" Text="000038192"></asp:TextBox>
                </td>
            </tr>
            <tr>
