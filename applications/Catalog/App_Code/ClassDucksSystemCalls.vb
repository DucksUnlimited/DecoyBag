...
Public Class ClassDucksSystemCalls
    ...
    Function GetStateChapterList(ByVal sRDNumber As String) As DataTable

        Try

            'Set URL 
            sURL = "http://www.ducksystem.com/cgibin/www.cgi?&tp=IS&pg=CBW284E&ex=" + sRDNumber
            ...
            dt1.Columns.Add("StateChapKey", Type.GetType("System.String"))
            ...
            Do While Not sLine Is Nothing
                ...
                If Not sLine Is Nothing Then
                    ...
                    dr1.Item("State") = sLine.Substring(2, 2)
                    dr1.Item("ChapterNumber") = sLine.Substring(4, 4)
                    dr1.Item("StateChapKey") = sLine.Substring(2, 6)
                    dr1.Item("ChapterName") = sLine.Substring(8)
    ...
    Function GetChapterListState(ByVal sState As String) As DataTable
        ...
        Try
            ...
            Do While Not sLine Is Nothing
                ...
                If Not sLine Is Nothing Then
                    ...
                    dr1.Item("ChapterName") = sLine.Substring(6)
                    'Add the row to the array
                    dt1.Rows.Add(dr1)
                End If
    ...
    Function GetRDListState(ByVal sState As String) As DataTable
    ...
    Function GetEventData(ByVal eventkey As String, ByVal eventdate As String, ByVal rdid As String, ByVal coorid As String, ByVal userid As String) As DataTable
        Try
            ...
            If month > 7 Then
                year = year + 1
            End If
            eventcode = objGen.TranslateEventCode(eventkey.Substring(5, 1))
    ...
    Function GetMemberData(ByVal statecode As String, ByVal lastname As String, ByVal firstname As String) As DataTable
    ...
    Function GetHouseholdData(ByVal cnaid As String) As DataTable
