...
Public Class GeneralRoutines
    ...
    Private Property DTConv() As DataTable
        Get
            If Session("DTConv") Is Nothing Then
                Session.Add("DTConv", New DataTable())
            End If

            Return DirectCast(Session("DTConv"), DataTable)
        End Get
        Set(ByVal value As DataTable)
            Session("DTConv") = value
        End Set
    End Property

    Private Property DTConvAttend() As DataTable
        Get
            If Session("DTConvAttend") Is Nothing Then
                Session.Add("DTConvAttend", New DataTable())
            End If

            Return DirectCast(Session("DTConvAttend"), DataTable)
        End Get
        Set(ByVal value As DataTable)
            Session("DTConvAttend") = value
        End Set
    End Property

    Private Property DTConvPay() As DataTable
        Get
            If Session("DTConvPay") Is Nothing Then
                Session.Add("DTConvPay", New DataTable())
            End If

            Return DirectCast(Session("DTConvPay"), DataTable)
        End Get
        Set(ByVal value As DataTable)
            Session("DTConvPay") = value
        End Set
    End Property
    ...
    Public Function ConvertField(ByVal field As String) As String
    ...
    End Sub
    Public Function TranslateEventCode(ByVal evcd As String) As String
    ...
    End Function
    Public Function TransEventCodeNtoA(ByVal evcd As String) As String
    ...
    Public Sub InzConventionTable()

        DTConv.Dispose()
        DTConv.Columns.Clear()
        DTConv.Reset()

        DTConv.Columns.Add("recnumber", Type.GetType("System.Double"))
        DTConv.Columns.Add("firstname", Type.GetType("System.String"))
        DTConv.Columns.Add("lastname", Type.GetType("System.String"))
        DTConv.Columns.Add("nickname", Type.GetType("System.String"))
        DTConv.Columns.Add("street1", Type.GetType("System.String"))
        DTConv.Columns.Add("street2", Type.GetType("System.String"))
        DTConv.Columns.Add("city", Type.GetType("System.String"))
        DTConv.Columns.Add("state", Type.GetType("System.String"))
        DTConv.Columns.Add("country", Type.GetType("System.String"))
        DTConv.Columns.Add("zipcode", Type.GetType("System.String"))
        DTConv.Columns.Add("phone", Type.GetType("System.String"))
        DTConv.Columns.Add("busphone", Type.GetType("System.String"))
        DTConv.Columns.Add("volcode", Type.GetType("System.String"))
        DTConv.Columns.Add("title1", Type.GetType("System.String"))
        DTConv.Columns.Add("title2", Type.GetType("System.String"))
        DTConv.Columns.Add("email", Type.GetType("System.String"))
        DTConv.Columns.Add("firstconv", Type.GetType("System.Boolean"))
        DTConv.Columns.Add("banquetonly", Type.GetType("System.Boolean"))
        DTConv.Columns.Add("cnaid", Type.GetType("System.String"))
        DTConv.Columns.Add("age", Type.GetType("System.Int32"))
        DTConv.Columns.Add("tour1", Type.GetType("System.String"))
        DTConv.Columns.Add("tour2", Type.GetType("System.String"))
        DTConv.Columns.Add("tour3", Type.GetType("System.String"))
        DTConv.Columns.Add("tour4", Type.GetType("System.String"))
        DTConv.Columns.Add("attending", Type.GetType("System.String"))
        DTConv.Columns.Add("perfmaddr", Type.GetType("System.String"))

        DTConvAttend.Dispose()
        DTConvAttend.Columns.Clear()
        DTConvAttend.Reset()

        DTConvAttend.Columns.Add("recnumber", Type.GetType("System.Double"))
        DTConvAttend.Columns.Add("activity", Type.GetType("System.String"))
        DTConvAttend.Columns.Add("amount", Type.GetType("System.Double"))
